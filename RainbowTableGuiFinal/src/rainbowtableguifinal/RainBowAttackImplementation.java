 ...
 * @author neilbannet
 */
public class RainBowAttackImplementation {
...
private Map<String, String> table;
     ...
     */
    public RainBowAttackImplementation(String charset, int passwordLength, int chainLength,
                        int numChains)
    {
